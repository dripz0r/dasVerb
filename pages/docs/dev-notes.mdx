---
title: Developer Notes & Gotchas
description: Tips, gotchas, and logic explanations for DasVerb contributors and maintainers.
---
...
## General Tips
- **Use the Docs:** Always check `/pages/docs/` for up-to-date structure and logic.
...
- **MDX Docs:** All docs/blogs must be in `/pages/docs/` for Nextra v2.
