...
export function Logo() {
  return (
    ...
    >
      <span
        className="inline-block font-extrabold tracking-tight bg-gradient-to-br from-primary via-fuchsia-500 to-accent text-transparent bg-clip-text transition-all duration-500 hover:from-accent hover:to-primary hover:via-indigo-400 animate-gradient"
