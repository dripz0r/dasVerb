      ...
      <div className="container mx-auto px-4 md:px-6 grid md:grid-cols-2 gap-8 items-center">
        <div className="space-y-6 text-center md:text-left">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-headline font-bold tracking-tight">
            German. <span className="text-primary">But make it Gen Z.</span>
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground">
            Stop snoozing through Deutsch class. Level up your language skills with DeutschTok – where learning is actually kinda fun. No cap.
          </p>
        ...
        <div className="relative aspect-video rounded-lg overflow-hidden shadow-2xl">
           <Image 
            ...
            alt="DeutschTok app preview" 
            fill
            data-ai-hint="language learning fun"
